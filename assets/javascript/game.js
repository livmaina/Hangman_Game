...
//Array of countrywords
var countryWords = ['Italy','Spain','Kenya','Venezuela','Greece','Germany','France','America','Argentina','Mexico','Belgium','Nigeria','South Africa','Ethiopia','Portugal','Israel','Iceland','Luxembourg','Ireland','Egypt','Morocco','Denmark','Austria','Belize','Cuba','Dominican Republic','Honduras','Japan'
];
...
function startGame() {
  ...
  guessedLetter = [];
  incorrectGuess = [];
  //Selects a countryword at random
  currentWord = countryWords[Math.floor(Math.random() * countryWords.length)];
